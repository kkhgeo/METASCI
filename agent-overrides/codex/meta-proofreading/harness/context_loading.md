...
| cross_section/structural_integrity.md | Skill directory | Cross-section question, Methods–Results, and scope checks |
| cross_section/quantitative_integrity.md | Skill directory | Paper-wide numeric and citation-risk triage |
| knowledge_index (metadata only) | Init scan | Show available knowledge |

**Do NOT load:** Writing-manual section files, full knowledge files, or the
remaining sentence/paragraph cross-section manuals (those load in Mode 2/3).
...
Mode 1 entry:
  ...
  4. Read cross_section/structural_integrity.md
  5. Read cross_section/quantitative_integrity.md for paper-wide risk triage

Mode 2 entry:
  6. Read full section text
  7. Read section-specific writing-manual
  8. Read the cross_section files from the section's INDEX.md routing row
  9. Match knowledge_index to section keywords
  10. Full-read matched knowledge files (Phase 2 load)
  11. Build Knowledge Bank for this section
  12. Distribute knowledge to reviewers
