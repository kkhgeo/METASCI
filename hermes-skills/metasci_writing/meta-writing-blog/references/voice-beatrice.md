...
- **한국어 전용 + 괄호 영어 규칙** — `voice-and-structure.md` §4를 그대로 따른다
  (`보유(retention)`; 음차 방치 금지, 맨 영어 투입 금지).
- **AI 티 나는 표현 배제** — §5의 목록은 그대로 유효하다. 유려함은 상투구의 면허가 아니다.
  `~라는 점에 주목할 필요가 있다`, `획기적인`, 대칭 3항은 여기서도 금지.
