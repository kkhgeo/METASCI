...
description: |
  ...
  다중 레퍼런스 + 최적화가 필요할 때만 쓴다. 단일 패스 단락 교정은 meta-rewriting,
  레퍼런스 대조만 필요하면 meta-review, 문체 프로파일 적용은 meta-styling.
allowed-tools: [Read, Write, Edit, Glob, Agent, WebSearch, WebFetch]
---
